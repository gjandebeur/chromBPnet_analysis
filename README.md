...
## Citation
This repository is an updated and recently run pipeline for the ChromBPNet model and software created by the Kundaje lab.
If you use this pipeline, please consider citing the original authors.
```
